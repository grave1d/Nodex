...
> আপনার Notion Custom Agent-কে Codex-এর মস্তিষ্ক হিসেবে ব্যবহার করুন।
...
Nodex আপনার Notion Custom Agent-কে একটি local, OpenAI-compatible Responses API-এর মাধ্যমে Codex-এর সাথে যুক্ত করে। Agent, model, persona, instructions এবং knowledge Notion-এ থাকে। Codex থাকে local workspace, যেখানে files, shell commands, patches এবং tools execute হয়।

**MCP নয়। Remote shell নয়। Nodex tools execute করে না।** Codex executes tools on your machine; Nodex only bridges requests, responses, and tool-call state.
...
Nodex হলো Notion Custom Agent এবং Codex-এর মধ্যে একটি local bridge। Notion-এ AI Agent তৈরি করুন, model নির্বাচন করুন, instructions লিখুন, Notion account Nodex-এর সাথে connect করুন, এবং Codex-কে Nodex custom API provider হিসেবে configure করুন।
